#ifndef Py_spython_PTRHEAD_STUBS_H
#define Py_spython_PTRHEAD_STUBS_H
...
/* Minimal pthread stubs for spython.
 *
 * The stubs implement the minimum pthread API for spython.
...
#endif // Py_spython_PTRHEAD_STUBS_H
