...
echo '# All API'
echo '#################################################'
run_capi --format summary Include/*.h Include/spython/*.h
run_capi --format table Include/*.h Include/spython/*.h
echo ''
echo ''
echo '#################################################'
echo '# stable API'
...
echo ''
echo '# public:'
run_capi --format summary --public --no-show-empty Include/spython/*.h
echo ''
echo '# private:'
run_capi --format summary --private --no-show-empty Include/spython/*.h
echo ''
run_capi --format full -v Include/spython/*.h
#run_capi --format full -v --public Include/spython/*.h
#run_capi --format full -v --private Include/spython/*.h
