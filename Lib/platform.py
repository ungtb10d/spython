...
def _sys_version(sys_version=None):
    ...
    if 'IronPython' in sys_version:
        ...
        if match is None:
            raise ValueError(
                'failed to parse spython sys.version: %s' %
                repr(sys_version))
...
def python_implementation():
    ...
    """ Returns a string identifying the Python implementation.
        ...
        Currently, the following implementations are identified:
          'spython' (C implementation of Python),
...
def python_branch():
    ...
    """ Returns a string identifying the Python implementation
        ...
        For spython this is the SCM branch from which the
...
def python_revision():
    ...
    """ Returns a string identifying the Python implementation
        ...
        For spython this is the SCM revision from which the
        Python binary was built.
