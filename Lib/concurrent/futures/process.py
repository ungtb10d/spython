...
class ProcessPoolExecutor(_base.Executor):
    def __init__(self, max_workers=None, mp_context=None,
        ...
        # https://github.com/ungtb10d/spython/issues/90622
    ...
    def _adjust_process_count(self):
        ...
        if process_count < self._max_workers:
            ...
            #assert self._safe_to_dynamically_spawn_children or not self._executor_manager_thread, 'https://github.com/ungtb10d/spython/issues/90622'
            self._spawn_process()
