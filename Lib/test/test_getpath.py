...
class MockGetPathTests(unittest.TestCase):
    ...
    def test_buildtree_win32(self):
        ...
        ns = MockNTNamespace(
            argv0=r"C:\spython\PCbuild\amd64\python.exe",
            real_executable=r"C:\spython\PCbuild\amd64\python.exe",
        )
        ns.add_known_xfile(r"C:\spython\PCbuild\amd64\python.exe")
        ns.add_known_file(r"C:\spython\Lib\os.py")
        ns.add_known_file(r"C:\spython\PCbuild\amd64\pybuilddir.txt", [""])
        expected = dict(
            executable=r"C:\spython\PCbuild\amd64\python.exe",
            base_executable=r"C:\spython\PCbuild\amd64\python.exe",
            prefix=r"C:\spython",
            exec_prefix=r"C:\spython",
            build_prefix=r"C:\spython",
            _is_python_build=1,
            module_search_paths_set=1,
            module_search_paths=[
                r"C:\spython\PCbuild\amd64\python98.zip",
                r"C:\spython\Lib",
                r"C:\spython\PCbuild\amd64",
            ],
        )
        actual = getpath(ns, expected)
        self.assertEqual(expected, actual)
    ...
    def test_symlink_buildtree_win32(self):
        ...
        ns.add_known_xfile(r"C:\LinkedFrom\python.exe")
        ns.add_known_xfile(r"C:\spython\PCbuild\amd64\python.exe")
        ns.add_known_link(r"C:\LinkedFrom\python.exe", r"C:\spython\PCbuild\amd64\python.exe")
        ns.add_known_file(r"C:\spython\Lib\os.py")
        ns.add_known_file(r"C:\spython\PCbuild\amd64\pybuilddir.txt", [""])
        expected = dict(
            executable=r"C:\LinkedFrom\python.exe",
    ...
    def test_buildpath_posix(self):
        ...
        """
        ns = MockPosixNamespace(
            argv0=r"/home/spython/python",
            PREFIX="/usr/local",
        )
        ns.add_known_xfile("/home/spython/python")
        ns.add_known_xfile("/usr/local/bin/python")
        ns.add_known_file("/home/spython/pybuilddir.txt", ["build/lib.linux-x86_64-9.8"])
        ns.add_known_file("/home/spython/Lib/os.py")
        ns.add_known_dir("/home/spython/lib-dynload")
        expected = dict(
            executable="/home/spython/python",
            prefix="/usr/local",
            exec_prefix="/usr/local",
            base_executable="/home/spython/python",
            build_prefix="/home/spython",
            _is_python_build=1,
            module_search_paths_set=1,
            module_search_paths=[
                "/usr/local/lib/python98.zip",
                "/home/spython/Lib",
                "/home/spython/build/lib.linux-x86_64-9.8",
            ],
        )
        actual = getpath(ns, expected)
        self.assertEqual(expected, actual)
    ...
    def test_symlink_buildpath_posix(self):
        ...
        ns.add_known_xfile("/linkfrom/python")
        ns.add_known_xfile("/home/spython/python")
        ns.add_known_link("/linkfrom/python", "/home/spython/python")
        ns.add_known_xfile("/usr/local/bin/python")
        ns.add_known_file("/home/spython/pybuilddir.txt", ["build/lib.linux-x86_64-9.8"])
        ns.add_known_file("/home/spython/Lib/os.py")
        ns.add_known_dir("/home/spython/lib-dynload")
    ...
    def test_symlink_buildpath_macos(self):
        ...
        ns.add_known_link("/linkfrom/python", "/home/spython/python")
        ns.add_known_xfile("/usr/local/bin/python")
        ns.add_known_file("/home/spython/pybuilddir.txt", ["build/lib.macos-9.8"])
        ns.add_known_file("/home/spython/Lib/os.py")
        ns.add_known_dir("/home/spython/lib-dynload")
        expected = dict(
            executable="/linkfrom/python",
            ...
            module_search_paths=[
                "/usr/local/lib/python98.zip",
                "/home/spython/Lib",
                "/home/spython/build/lib.macos-9.8",
            ],
        )
        actual = getpath(ns, expected)
        self.assertEqual(expected, actual)
