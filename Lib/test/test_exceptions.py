...
class ExceptionTests(unittest.TestCase):
    ...
    def testExceptionCleanupState(self):
        ...
        try:
            ...
            gc_collect()  # For PyPy or other GCs.
            obj = wr()
            # guarantee no ref cycles on spython (don't gc_collect)
            if check_impl_detail(spython=False):
                gc_collect()
            self.assertIsNone(obj)
    ...
    def test_memory_error_in_PyErr_PrintEx(self):
        ...
        # Span a large range of tests as the spython code always evolves with
