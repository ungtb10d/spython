...
class RunTests(BaseTest):
    ...
    def test_asyncio_run_set_event_loop(self):
        #See https://github.com/ungtb10d/spython/issues/93896
    ...
    def test_asyncio_run_without_uncancel(self):
        # See https://github.com/ungtb10d/spython/issues/95097
        class Task:
...
class RunnerTests(BaseTest):
    ...
    def test_set_event_loop_called_once(self):
        # See https://github.com/ungtb10d/spython/issues/95736
        async def coro():
            pass
