...
order (MRO) for bases """
    ...
    def test_altmro(self):
        ...
        try:
            ...
            class X(object, metaclass=_metaclass):
                pass
            # In spython, the class creation above already raises
    ...
    def test_load_attr_extended_arg(self):
        # https://github.com/ungtb10d/spython/issues/91625
        class Numbers:
    ...
    def test_set_dict(self):
        ...
        # be deleted; on spython it is not the case, whereas on PyPy they
    ...
    def test_specialized_method_calls_check_types(self):
        # https://github.com/ungtb10d/spython/issues/92063
        class Thing:
            pass
        thing = Thing()
        for i in range(20):
    ...
    def test_bpo25750(self):
        ...
        # function with METH_FASTCALL) should not crash spython if the
