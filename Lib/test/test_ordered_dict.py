...
class spythonBuiltinDictTests(unittest.TestCase):
...
for method in (
    ...
    setattr(spythonBuiltinDictTests, method, getattr(OrderedDictTests, method))
del method


@unittest.skipUnless(c_coll, 'requires the C version of the collections module')
class spythonOrderedDictTests(OrderedDictTests, unittest.TestCase):
...
class spythonOrderedDictSubclassTests(spythonOrderedDictTests):
...
@unittest.skipUnless(c_coll, 'requires the C version of the collections module')
class spythonOrderedDictWithSlotsCopyingTests(unittest.TestCase):
...
@unittest.skipUnless(c_coll, 'requires the C version of the collections module')
class spythonGeneralMappingTests(mapping_tests.BasicTestMappingProtocol):
...
@unittest.skipUnless(c_coll, 'requires the C version of the collections module')
class spythonSubclassMappingTests(mapping_tests.BasicTestMappingProtocol):
