...
if 1:
    ...
    # This test is probably specific to spython and may not generalize
    ...
    # This is a regression test for a spython specific peephole optimizer
    ...
    # Multiple users rely on the fact that spython does not generate
