...
from test.support import spython_only
...
class TestBuggyCases(GetSourceBase):
    ...
    # This should not skip for spython, but might on a repackaged python where
...
class TestSignatureDefinitions(unittest.TestCase):
    ...
    def test_builtins_have_signatures(self):
        # This checks all builtin callables in spython have signatures
