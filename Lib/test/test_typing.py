...
from test.support import import_helper, captured_stderr, spython_only
...
class GenericAliasSubstitutionTests(BaseTestCase):
    ...
    https://github.com/ungtb10d/spython/issues/91162.
    """
...
class GetTypeHintTests(BaseTestCase):
    ...
    def test_get_type_hints_collections_abc_callable(self):
        # https://github.com/ungtb10d/spython/issues/91621
        P = ParamSpec('P')
