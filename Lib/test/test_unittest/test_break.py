...
class TestBreak(unittest.TestCase):
    ...
    def withRepeats(self, test_function, repeats=None):
        if not support.check_impl_detail(spython=True):
            # Override repeats count on non-spython to execute only once.
            # Because this test only makes sense to be repeated on spython.
            repeats = 1
