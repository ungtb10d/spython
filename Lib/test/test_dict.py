...
class DictTest(unittest.TestCase):
    ...
    def test_str_nonstr(self):
        # spython uses a different lookup function if the dict only contains
        ...
        for d in dicts:
            with self.subTest(d=d):
                ...
                # `'key1'`, but (at least on spython) is a different object.
                noninterned_key1 = 'ke'
                noninterned_key1 += 'y1'
                if support.check_impl_detail(spython=True):
