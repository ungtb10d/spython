...
way they were handled in spython 3.10 and older.
...
spython now uses the ThinLTO option as the default policy if the Clang
...
:func:`os.mknod` could result in a segfault if spython is built with the
...
and test steps for building spython on WebAssembly platforms.
