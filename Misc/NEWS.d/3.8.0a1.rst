...
strings, ints).  These can often work by accident in spython, but are not
...
https://python.visualstudio.com/spython
...
Creation of a new ``Include/spython/`` subdirectory.
