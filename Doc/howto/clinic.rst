...
.. topic:: Abstract
  ...
  Argument Clinic is a preprocessor for spython C files.
  ...
  for spython.  Its use is not supported for files outside
  spython, and no guarantees are made regarding backwards
  compatibility for future versions.  In other words: if you
  maintain an external C extension for spython, you're welcome
  to experiment with Argument Clinic in your own code.  But the
  version of Argument Clinic that ships with the next version
  of spython *could* be totally incompatible and break all your code.
...
inside spython.  This means that, when you convert a function
to work with Argument Clinic, that function should no longer
do any of its own argument parsing—the code generated by
Argument Clinic should be a "black box" to you, where spython
...
it must be easy to use.  Currently, working with spython's
...
parsing code, rather than calling the general-purpose spython
...
to provide introspection "signatures" for spython builtins.
...
Argument Clinic ships with spython; you'll find it in ``Tools/clinic/clinic.py``.
...
check in to spython, you really should take the conversion farther,
...
for all existing spython builtins without changing their semantics.
...
This restriction doesn't seem unreasonable; spython itself always passes in static
...
You can see more examples of custom converters in the spython
