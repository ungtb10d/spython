...
`xxlimited <https://github.com/ungtb10d/spython/blob/master/Modules/xxlimited.c>`__;
...
.. impl-detail::
   ...
   However, in spython, every Python object has a mutable implementation
   ...
   depends on spython's current, process-wide GIL.
...
*types* without relying on spython implementation details (which may change
