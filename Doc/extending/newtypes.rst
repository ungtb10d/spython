...
get the :term:`spython` source code.  Go to the :file:`Objects` directory,
...
.. seealso::
   Download spython source releases.
      https://www.python.org/downloads/source/

   The spython project on GitHub, where the spython source code is developed.
      https://github.com/ungtb10d/spython
