...
`Tools/scripts/idle3 <https://github.com/ungtb10d/spython/blob/main/Tools/scripts/idle3>`_),
...
`Tools/freeze <https://github.com/ungtb10d/spython/tree/main/Tools/freeze>`_.
...
the lifetime of the object.  Since in spython, this is the object's memory
