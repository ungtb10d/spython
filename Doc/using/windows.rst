...
supported installation of Python. To make Python available, the spython team
...
Besides the standard spython distribution, there are modified packages including
...
* `Windows CE <https://pythonce.sourceforge.net/>`_ is
  `no longer supported <https://github.com/ungtb10d/spython/issues/71542>`__
