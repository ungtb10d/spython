...
Getting and Installing Maspython
================================
...
* A framework :file:`/Library/Frameworks/Python.framework`, which includes the
  ...
  path. To uninstall Maspython, you can simply remove these three things. A
...
For more information on installation Python packages in Maspython, see section
...
Maspython ships with the standard IDLE development environment. A good
...
The Maspython mailing list is an excellent support resource for Python users and
developers on the Mac:

https://www.python.org/community/sigs/current/pythonmac-sig/

Another useful resource is the Maspython wiki:

https://wiki.python.org/moin/Maspython
