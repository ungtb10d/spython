...
The spython interpreter scans the command line and the environment for various
settings.
...
.. cmdoption:: -c <command>
   ...
   .. audit-event:: spython.run_command command cmdoption-c
...
.. cmdoption:: -m <module-name>
   ...
   .. audit-event:: spython.run_module module-name cmdoption-m
...
.. describe:: <script>
   ...
   .. audit-event:: spython.run_file filename
...
.. cmdoption:: -X
   ...
   Reserved for various implementation-specific options.  spython currently
...
.. envvar:: PYTHONSTARTUP
   ...
   .. audit-event:: spython.run_startup filename envvar-PYTHONSTARTUP

      Raises an :ref:`auditing event <auditing>` ``spython.run_startup`` with
