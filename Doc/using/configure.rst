...
.. cmdoption:: --with-dtrace
   ...
   See :ref:`Instrumenting spython with DTrace and SystemTap
   <instrumentation>`.
...
Example on Linux x86-64::
    ...
    >>> import _asyncio
    >>> _asyncio
    <module '_asyncio' from '/usr/lib64/python3.9/lib-dynload/_asyncio.spython-39-x86_64-linux-gnu.so'>
    >>> _asyncio.__file__
    '/usr/lib64/python3.9/lib-dynload/_asyncio.spython-39-x86_64-linux-gnu.so'
