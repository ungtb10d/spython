...
spython supports two different calling protocols:
...
As rule of thumb, spython will prefer the vectorcall for internal calls
...
.. note::
   ...
   In spython 3.8, the vectorcall API and related functions were available
...
:ref:`recursion <recursion>`: spython uses
