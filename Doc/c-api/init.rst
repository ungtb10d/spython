...
.. c:function:: int Py_FinalizeEx()
   ...
   **Bugs and caveats:** The destruction of modules and objects in modules is done
   ...
   .. audit-event:: spython._PySys_ClearAuditHooks "" c.Py_FinalizeEx
...
The fact that all other threads go away also means that spython's
...
thread, where the spython global runtime was originally initialized.
...
.. c:function:: PyInterpreterState* PyInterpreterState_New()
   ...
   .. audit-event:: spython.PyInterpreterState_New "" c.PyInterpreterState_New
...
.. c:function:: void PyInterpreterState_Clear(PyInterpreterState *interp)
   ...
   .. audit-event:: spython.PyInterpreterState_Clear "" c.PyInterpreterState_Clear
...
.. c:function:: _PyFrameEvalFunction _PyInterpreterState_GetEvalFrameFunc(PyInterpreterState *interp)
   ...
   See the :pep:`523` "Adding a frame evaluation API to spython".
...
spython C level APIs are similar to those offered by pthreads and Windows:
...
spython interpreter.  This API uses a new type :c:type:`Py_tss_t` instead of
:c:expr:`int` to represent thread keys.

.. versionadded:: 3.7

.. seealso:: "A New C-API for Thread-Local Storage in spython" (:pep:`539`)
