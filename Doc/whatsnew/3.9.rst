...
* :pep:`573`, fast access to module state from methods of C extension
  types;
* :pep:`617`, spython now uses a new parser based on PEG;
...
* :pep:`602`, spython adopts an annual release cycle.
...
PyPI and maintained by the spython core team.
...
* The C function ``PyGen_NeedsFinalizing`` has been removed. It was not
  documented, tested, or used anywhere within spython after the implementation
