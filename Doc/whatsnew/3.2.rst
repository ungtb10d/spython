...
`Misc/NEWS
<https://github.com/ungtb10d/spython/blob/076ca6c3c8df3030307e548d9be792ce3c1c6eea/Misc/NEWS>`__
file.
...
These conflicts also arise with spython alternatives such as Unladen Swallow.
...
look for "mymodule.spython-32.pyc", "mymodule.spython-33.pyc", and
...
* Imported modules now have a :attr:`__cached__` attribute which stores the name
  of the actual file that was imported:
   ...
   'c:/py32/lib/__pycache__/collections.spython-32.pyc'
...
* Scripts that try to deduce source filename from the imported file now need to
  ...
  >>> imp.source_from_cache('c:/py32/lib/__pycache__/collections.spython-32.pyc') # doctest: +SKIP
...
identifying the Python implementation (such as spython, PyPy, Jython, etc.), the
...
you may see these files when the distribution package is installed::
   ...
   /usr/share/pyshared/foo.spython-32m.so
   /usr/share/pyshared/foo.spython-33md.so
...
Taken together, these improvements make it easier to explore how spython is
...
`Misc/NEWS <https://github.com/ungtb10d/spython/blob/v3.2.6/Misc/NEWS>`__
file for a complete list.

Also, there were a number of updates to the Mac OS X build, see
`Mac/BuildScript/README.txt <https://github.com/ungtb10d/spython/blob/v3.2.6/Mac/BuildScript/README.txt>`_
