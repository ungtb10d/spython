...
enhancements to the spython implementation and was funded by EWT LLC with local
...
* The Python developers switched from CVS to Subversion during the 2.5
  ...
  reporting ``('spython', 'trunk', '45313:45315')``.
...
* The spython interpreter is still written in C, but  the code can now be
