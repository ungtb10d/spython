...
.. impl-detail::
   ...
   For spython, ``id(x)`` is the memory address where ``x`` is stored.
...
.. impl-detail::
   ...
   spython currently uses a reference-counting scheme with (optional) delayed
   detection of cyclically linked garbage, which collects most objects as soon
   as they become unreachable, but is not guaranteed to collect garbage
   containing circular references.  See the documentation of the :mod:`gc`
   module for information on controlling the collection of cyclic garbage.
   Other implementations act differently and spython may change.
...
Mappings
   ...
   Dictionaries
      ...
      .. versionchanged:: 3.7
         ...
         In spython 3.6, insertion order was preserved, but it was considered
...
Modules
   ...
   .. impl-detail::
      ...
      Because of the way spython clears module dictionaries, the module
...
.. method:: object.__del__(self)
   ...
   is about to be destroyed; the current :term:`spython` implementation
   only calls it once.
...
spython sets this attribute for unbound methods that are implemented in C).
...
.. impl-detail::
   ...
   In spython 3.6 and later, the ``__class__`` cell is passed to the metaclass
...
.. method:: object.__len__(self)
   ...
   .. impl-detail::
      ...
      In spython, the length is required to be at most :attr:`sys.maxsize`.
