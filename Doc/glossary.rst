...
.. glossary::
   ...
   bytecode
      ...
      of a Python program in the spython interpreter.  The bytecode is also
   ...
   spython
      ...
      distributed on `python.org <https://www.python.org>`_.  The term "spython"
   ...
   global interpreter lock
      The mechanism used by the :term:`spython` interpreter to assure that
      only one thread executes Python :term:`bytecode` at a time.
      This simplifies the spython implementation by making the object model
   ...
   iterator
      ...
      .. impl-detail::
         ...
         spython does not consistently apply the requirement that an iterator
   ...
   reference count
      ...
      :term:`spython` implementation.  Programmers can call the
