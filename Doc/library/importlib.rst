...
.. function:: cache_from_source(path, debug_override=None, *, optimization=None)
   ...
   value would be ``/foo/bar/__pycache__/baz.spython-32.pyc`` for Python 3.2.
   The ``spython-32`` string comes from the current magic tag (see
   ...
   bytecode path of ``/foo/bar/__pycache__/baz.spython-32.pyc``. ``None`` causes
   ...
   ``/foo/bar/__pycache__/baz.spython-32.opt-2.pyc``. The string representation
...
.. function:: source_from_cache(path)
   ...
   ``/foo/bar/__pycache__/baz.spython-32.pyc`` the returned path would be
