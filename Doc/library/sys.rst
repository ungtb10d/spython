...
.. function:: addaudithook(hook)
   ...
   spython, and :pep:`578` for the original design discussion.
...
.. function:: _debugmallocstats()
   ...
   Print low-level information to stderr about the state of spython's memory
   allocator.
   ...
   .. impl-detail::
      ...
      This function is specific to spython.  The exact output format is not
...
.. data:: implementation
   ...
   *name* is the implementation's identifier, e.g. ``'spython'``.  The actual
   ...
   *implementation*.  This has a distinct meaning from the specific
   ...
   would be ``sys.version_info(2, 7, 2, 'final', 0)``.  For spython they
   ...
   *cache_tag* is the tag used by the import machinery in the filenames of
   ...
   implementation's name and version, like ``'spython-33'``.  However, a
...
.. data:: __interactivehook__
   ...
   .. audit-event:: spython.run_interactivehook hook sys.__interactivehook__

      Raises an :ref:`auditing event <auditing>`
      ``spython.run_interactivehook`` with the hook object as the argument when
...
.. data:: _xoptions
   ...
   .. impl-detail::
      ...
      This is a spython-specific way of accessing options passed through
