...
GH_ISSUE_URI = 'https://github.com/ungtb10d/spython/issues/%s'
SOURCE_URI = 'https://github.com/ungtb10d/spython/tree/main/%s'
...
class ImplementationDetail(Directive):
    ...
    label_text = 'spython implementation detail:'
