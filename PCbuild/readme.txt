...
This directory is used to build spython for Microsoft Windows on 32- and 64-
...
Debug
    ...
    development of spython, you will most likely use this configuration.
...
The spython project is split up into several smaller sub-projects which
...
a functioning spython interpreter.  If nothing else builds but these,
...
_ssl
    ...
    https://github.com/ungtb10d/spython-bin-deps.
    ...
    https://github.com/ungtb10d/spython-source-deps.
